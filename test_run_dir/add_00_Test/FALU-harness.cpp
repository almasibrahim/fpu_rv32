...
#endif
#include <iostream>
class FALU_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    FALU_api_t(VFALU* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
    ...
    void init_sim_data() {
        ...
        sim_data.signal_map["FALU.reset"] = 0;
    }
#if VM_TRACE
...
int main(int argc, char **argv, char **env) {
    ...
    VFALU* top = new VFALU;
    std::string vcdfile = "test_run_dir/add_00_Test/FALU.vcd";
    ...
    Verilated::mkdir("test_run_dir/add_00_Test/logs");
    VerilatedCov::write("test_run_dir/add_00_Test/logs/coverage.dat");
#endif
    delete top;
    exit(0);
}
