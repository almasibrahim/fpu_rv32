...
int main(int argc, char **argv, char **env) {
    ...
    VFALU* top = new VFALU;
    std::string vcdfile = "test_run_dir/FALU_Test/FALU.vcd";
    ...
    Verilated::mkdir("test_run_dir/FALU_Test/logs");
    VerilatedCov::write("test_run_dir/FALU_Test/logs/coverage.dat");
#endif
    delete top;
    exit(0);
}
